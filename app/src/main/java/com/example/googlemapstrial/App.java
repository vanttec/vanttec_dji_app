/**
 * Class copied from DJI tutorial
 * source code: https://github.com/DJI-Mobile-SDK-Tutorials/Android-MediaManagerDemo/blob/master/MediaManagerDemo/app/src/main/java/com/dji/mediaManagerDemo/DemoApplication.java
 * */
...
public class App extends Application {
    ...
    public static boolean isCameraModuleAvailable() {
        return isProductModuleAvailable() &&
                (null != App.getProductInstance().getCamera());
    }
